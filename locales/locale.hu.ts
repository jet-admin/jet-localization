...
export const locale: Locale = {
  ...
  items: [
    ...
    { source: 'Clear Team', target: 'Tiszta csoport' },
    ...
    { source: 'Page Permissions', target: 'Oldal-jogosultságok' },
    { source: 'App Permissions', target: 'Alkalmazás-jogosultságok' },
    ...
    { source: 'App Builder', target: 'Alkalamzás szerzkesztő' },
    ...
    { source: 'Basic information about your account.', target: 'Fiók-információk' },
    ...
    { source: 'Your Email', target: 'Az email címe' },
    ...
    { source: 'Search templates...', target: 'Keresési a sablonok között...' },
    { source: 'any', target: 'bármi' },
    { source: 'more', target: 'több' },
    { source: 'Choose Data Source', target: 'Válasszon az adatforrást' },
    ...
    { source: 'Reset password & Sign In', target: 'Jelszó visszaállítása és bejelentkezés' },
    { source: 'Unable to Send Code', target: 'A kód nem, küldhető el' },
    { source: 'Unable to Change Password', target: 'A jelszót nem lehet módosítani' },
