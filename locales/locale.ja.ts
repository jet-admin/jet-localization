...
export const locale: Locale = {
  ...
  items: [
    ...
    {
      source: "Enter at least {0} characters",
      target: "{0}文字以上入力してください",
    },
    ...
    {
      source: "We are fetching {0}, please, wait...",
      target: "{0}を取得中です。しばらくお待ちください...",
    },
    ...
    {
      source: "{0} is not greater than or equals {1}",
      target: "{0}が{1}以上でない",
    },
    ...
    {
      source: "{0} is not less than or equals {1}",
      target: "{0}が{1}以下でない",
    },
    ...
    {
      source: "{0} is current quarter",
      target: "{0} が今期",
    },
    {
      source: "{0} is not current quarter",
      target: "{0} が今期でない",
    },
    ...
    {
      source: "is not previous quarter",
      target: "が前期ではない",
    },
    {
      source: "{0} is previous quarter",
      target: "{0} が前期",
    },
    {
      source: "{0} is not previous quarter",
      target: "{0} が前期ではない",
    },
    ...
    {
      source: "is not previous X days",
      target: "が過去 x 日ではない",
    },
    {
      source: "{0} is previous {1} days",
      target: "{0} が過去 {1} 日",
    },
    {
      source: "{0} is not previous {1} days",
      target: "{0} が過去 {1} 日ではない",
    },
    ...
    {
      source: "{0} covered by {1}",
      target: "{0}が{1}によってカバーされている",
    },
    {
      source: "{0} is not covered by {1}",
      target: "{0}が{1}によってカバーされていない",
    },
    ...
    {
      source: "Start chatting with your team",
      target: "チームとのチャットを開始",
    },
    {
      source:
      ...
      target:
        "重要な情報を追跡するために現在のページについてのメッセージを取得します。",
    },
    ...
    {
      source:
        "Enter the email of the user you’d like to invite to collaborate.",
    ...
    {
      source:
        "Anyone on the internet with this link will be able to join the selected team.",
      target:
        "このリンクを知っているすべての人が、選択したチームに参加できます。",
    },
    ...
    {
      source: "Updating public access...",
      target: "パブリックアクセスを更新中...",
    },
    {
      source:
    ...
    {
      source:
        "Paste this code into the HTML code of your website where you would like current page to appear.",
      target:
        "このコードをWebサイトのHTMLコードに貼り付けると現在のページが表示されます。",
    },
    ...
    { source: "Clear Team", target: "チームをクリア" },
    {
      ...
      target: "アプリケーションの構築とデータの変更が可能",
    },
    {
      source: "Can modify data in application",
      target: "アプリケーション内のデータの変更が可能",
    },
    {
    ...
    { source: "Enter Team Name", target: "チーム名を入力" },
    {
      ...
      target:
        "チーム名を入力してください。（サポート、営業、マーケティングなど）",
    },
    {
      source: "Add a new member to this team.",
      target: "このチームに新しいメンバーを追加します。",
    },
    ...
    {
      source: "No users in this team",
      target: "このチームにはユーザーがいません",
    },
    ...
    {
      source: "No properties specified",
      target: "プロパティが指定されていません",
    },
    ...
    {
      source: "Basic information about your account.",
      target: "自分のアカウントの基本情報",
    },
    ...
    {
      source: "works with 30+ data sources",
      target: "30以上のデータソースで動作",
    },
    ...
    },
    {
      ...
      target:
        "Stripe、Twilio、GraphQLなどのデータベース、アプリ、APIに基づいたカスタム管理パネルを構築します。",
    },
    ...
    },
    {
      ...
      target:
        "カードは不要です。14日間のPROトライアル期間中、すべての高度な機能を無料で利用できます。",
    },
    ...
    { source: "Repeat Password", target: "パスワードを再入力" },
    {
      ...
      target:
        "アカウントを作成することは、私たちの規約とポリシーに同意したことを意味します。",
    },
    ...
    { source: "Return to Sign In", target: "サインインに戻る" },
    {
      ...
      target:
        "メールを確認してください – <strong>{0}</strong>。パスワードを変更するための確認URLを送信しました。",
    },
    {
      source:
