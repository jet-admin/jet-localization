...
export const locale: Locale = {
  ...
  items: [
    ...
    { source: 'Are you sure want to close?', target: 'Czy na pewno chcesz zamknąć?' },
    { source: 'Close', target: 'Zamknij' },
    ...
    { source: 'Change Password', target: 'Zmień hasło' },
    {
      ...
      target: 'Aktualne hasło zostało pomyślnie zaktualizowane, wszystkie inne sesje zostaną wkrótce wylogowane'
    },
    ...
    { source: 'and', target: 'i' },
    { source: 'Create account', target: 'Utwórz konto' },
