...
export const locale: Locale = {
    ...
    items: [
        ...
        { source: 'Unfortunately, no {0} matching your query found', target: 'Maalesef aramanızla eşleşen {0} bulunamadı' },
        ...
        { source: 'Unfortunately, this component is not configured yet', target: 'Maalesef bu bileşen henüz yapılandırılmamış' },
        ...
        { source: 'Start to working with data to log activities.', target: 'Aktiviteleri kaydetmek için verilerle çalışmaya başlayın.' },
        ...
        { source: 'Take a message about current page to keep track of important info.', target: 'Önemli bilgileri takip etmek için mevcut sayfa hakkında not alın.' },
        ...
        { source: 'Limit access to your data by user properties', target: 'Verilerinize erişimi kullanıcı özelliklerine göre sınırlayın' },
        {
            source: 'Enter the email of the user you’d like to invite to collaborate.', target: 'Lütfen davet etmek istediğiniz kullanıcının e-postasını girin.'
        },
        ...
        { source: 'Anyone on the internet with this link will be able to join the selected team.', target: 'Bu bağlantıya sahip olan herkes seçili ekibe katılabilecek.' },
        ...
        { source: 'You are setting sharing for the current page', target: 'Mevcut sayfa için paylaşım ayarlarını yapıyorsunuz' },
        { source: 'You are setting sharing for all pages of your App.', target: 'Uygulamanızın tüm sayfaları için paylaşım ayarlarını yapıyorsunuz.' },
        ...
        { source: 'Anyone with this link will be able to view current page. This way you can also embed current page into another website.', target: 'Bu bağlantıya sahip olan herkes mevcut sayfayı görüntüleyebilecek. Bu şekilde mevcut sayfayı başka bir web sitesine de gömebilirsiniz.' },
        { source: 'Embed code (IFRAME)', target: 'Gömme kodu (IFRAME)' },
        { source: 'Paste this code into the HTML code of your website where you would like current page to appear.', target: 'Bu kodu, mevcut sayfanın görünmesini istediğiniz web sitenizin HTML koduna yapıştırın.' },
        ...
        { source: 'Can only view data without modification', target: 'Verileri sadece görüntüleyebilir, değiştiremez' },
        { source: 'Add Team', target: 'Ekip Ekle' },
        { source: 'Edit Team', target: 'Ekibi Düzenle' },
        { source: 'Adding Team', target: 'Ekip Ekleniyor' },
        { source: 'Keep control over who has access to current App', target: 'Mevcut Uygulamaya kimlerin erişimi olduğunu kontrol edin' },
        { source: 'Enter Team Name', target: 'Ekip Adı Girin' },
        { source: 'Type the team name, i.e: Support, Sales, Marketing, etc.', target: 'Ekip adını girin, örn: Destek, Satış, Pazarlama, vb.' },
        ...
        { source: "Grant permissions to app's collection", target: 'Uygulamanın koleksiyonuna izin verin' },
        { source: 'Collection', target: 'Koleksiyon' },
        { source: 'Limit access to your data by team properties', target: 'Verilerinize erişimi ekip özelliklerine göre sınırlayın' },
        ...
        { source: 'Password Change', target: 'Şifre Değiştirme' },
        {
            ...
            target: 'Şifreniz hesabınızı korumak için yeterince güçlü olmalıdır, bu nedenle en az 12 karakter uzunluğunda olmalıdır.'
        },
        ...
        { source: 'News & Proposals', target: 'Haberler ve Öneriler' },
        {
            ...
            target: 'Güncellemelerimize ve önerilerimize abone olun.'
        },
        ...
        { source: "Can't find resource you're looking for?", target: 'Aradığınız kaynağı bulamıyor musunuz?' },
        ...
        },
        {
            ...
            target: 'Stripe, Twilio ve GraphQL gibi herhangi bir veritabanı, uygulama ve API\'ye dayalı özel bir yönetici paneli oluşturun.'
        },
        ...
        {
            source: 'Please check your Email – <strong>{0}</strong>. We have sent the validation link you should follow to change your password.',
            target: 'Lütfen E-postanızı kontrol edin – <strong>{0}</strong>. Şifrenizi değiştirmek için takip etmeniz gereken doğrulama bağlantısını gönderdik.'
        },
        {
