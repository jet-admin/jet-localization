...
export const locale: Locale = {
  ...
  items: [
    ...
    { source: 'Submit', target: 'Надіслати' },
    ...
    { source: 'Are you sure want to close?', target: 'Ви впевнені, що хочете закрити?' },
    { source: 'Close', target: 'Закрити' },
    ...
    { source: 'Change Password', target: 'Змінити пароль' },
    {
      ...
      target: 'Поточний пароль успішно оновлено, всі інші сеанси незабаром будуть завершені'
    },
